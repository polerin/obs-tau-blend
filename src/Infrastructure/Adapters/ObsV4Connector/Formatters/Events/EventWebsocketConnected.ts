...
import { ObsMessages, SystemMessageSet, SystemMessageNames } from "Shared/MessageHandling";
    ...
    IV4EventTransformer<typeof ObsMessages.WebsocketConnected, "ConnectionOpened">
{
    ...
    public buildSystemMessage(obsMessage: ObsV4EventHandlersData["ConnectionOpened"]): SystemMessageSet[typeof ObsMessages.WebsocketConnected] {
        return {
            type : "obsMessage",
